  ...
  render: function () {
    ...
    return (
      React.DOM.div(null, 
        ...
        React.DOM.div(null, "Active: ", this.state.color.toHex()), 
        React.DOM.div(null, "Origin: ", this.state.origin), 
    ...
    return (
      ...
      React.DOM.div({className: "details"}, 
        React.DOM.ul({className: "rgb"}, 
          React.DOM.li(null, 
            React.DOM.label(null, "R:"), 
            React.DOM.span({className: "value"},  rgb.r)
          ), 
          React.DOM.li(null, 
            React.DOM.label(null, "G:"), 
            React.DOM.span({className: "value"},  rgb.g)
          ), 
          React.DOM.li(null, 
            React.DOM.label(null, "B:"), 
            React.DOM.span({className: "value"},  rgb.b)
          )
        ), 
        ...
        React.DOM.ul({className: "hex"}, 
          React.DOM.li(null, React.DOM.label(null, "#"), 
          React.DOM.span({className: "value"},  hex.slice(1) ))
        )
      )
      /* jshint ignore: end */
    );
